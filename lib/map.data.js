...
Map.Data.set = function(type,x,y,i){
	...
	var remove_wall = false;
	var remove_liquid = false;
	var remove_npc = false;
	var remove_entity = false;
	...
	if(remove_block){ delete Map.Data.blocks[x][y]; }
	if(remove_wall){ delete Map.Data.walls[x][y]; }
	if(remove_liquid){ delete Map.Data.liquids[x][y]; }
	if(remove_npc){ delete Map.Data.npcs[x][y]; }
	if(remove_entity){ delete Map.Data.entities[x][y]; }
